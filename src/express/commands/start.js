...
export async function start() {
  ...
  shell.cp(
    `../../configs/devnet/${devnetType}-setup-config.yaml ../../deployments/devnet-${devnetId}`
  )
  shell.cp(
    `../../configs/devnet/openmetrics-conf.yaml ../../deployments/devnet-${devnetId}`
  )
  shell.cp(
    `../../configs/devnet/otel-config-dd.yaml ../../deployments/devnet-${devnetId}`
  )
