...
export async function sendStateSyncTx() {
  ...
  const icommand = 'cd ~/matic-cli/devnet/code/pos-contracts && export PATH="$HOME/.foundry/bin:$PATH" && forge init'
  await runSshCommand(`${doc.ethHostUser}@${machine0}`, icommand, maxRetries)

  const command = `export PATH="$HOME/.foundry/bin:$PATH" && forge script ~/matic-cli/devnet/code/pos-contracts/scripts/matic-cli-scripts/Deposit.s.sol:MaticDeposit --rpc-url http://localhost:9545 --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 --broadcast --sig "run(address,address,uint256)" 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 ${MaticToken} 100000000000000000000`
